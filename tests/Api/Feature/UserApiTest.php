...
class UserApiTest extends TestCase
{
    ...
    /**
     * Test that the /user endpoint returns the authenticated user's name and email.
     */
    public function testMeEndpointReturnsUserNameAndEmail(): void
    {
        ...
        // Assert the response contains name and email
        $response->assertJson([
            'name' => 'John Doe',
            'email' => 'john.doe@example.com',
        ]);
    ...
    /**
     * Test that the /user endpoint works with the standard user role.
     */
    ...
    /**
     * Test that the /user endpoint works with admin role.
     */
    ...
    /**
     * Test that the /user endpoint handles users with null names gracefully.
     */
    ...
    /**
     * Test that the /user endpoint works with expired tokens (should fail).
     */
