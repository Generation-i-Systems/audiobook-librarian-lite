...
class BadgeController extends Controller
{
    ...
    public function index(): View
    {
        ...
        $badges->each(function (Badge $badge): void {
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        $imageUrl = $this->storeUploadedImage($request, $validated['key']);
        $data['image_url'] = $imageUrl;
        $data['icon_path'] = $imageUrl;
    ...
    public function activate(Badge $badge): RedirectResponse
    {
     ...
     */
    public function forceDestroy(Badge $badge): RedirectResponse
    {
